...
public class UnplannedActivity extends AbstractActivity{
    ...
    public UnplannedActivity(int id, Sito sito, String tipologia, String descrizione, int tempo, List<String> materiali, int week, Boolean interrompibile, Procedure procedura,String wNotes) {
